...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Experilabs LLM")
if WEBUI_NAME != "Experilabs LLM":
    WEBUI_NAME += " (Experilabs LLM)"
...
DATABASE_URL = os.environ.get("DATABASE_URL", f"postgresql://postgres:postgres@localhost:5432/webui")
